...
" Enable advanced command options
...
" Tìm kiếm tags trong buffer hiện tại
...
" " Avante key mappings
" nnoremap <leader>aa <Plug>(AvanteAsk)
" nnoremap <leader>ae <Plug>(AvanteEdit)
" nnoremap <leader>ar <Plug>(AvanteRefresh)
